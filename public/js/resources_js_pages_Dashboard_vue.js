      ...
      fn: function fn(_ref) {
        ...
        return _vm._l(rows, function (row) {
          return _c("base-table-row", {
            key: row.id
          }, [_c("base-table-column", [_vm._v(_vm._s(_vm.formatDate(row.created_at)))]), _vm._v(" "), _c("base-table-column", [_vm._v(_vm._s(row.name))]), _vm._v(" "), _c("base-table-column", [_vm._v(_vm._s(row.email))]), _vm._v(" "), _c("base-table-column", {
